...
@SupportedAnnotationTypes("zh.annoation.proccess")
public class TestAnnoationProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnvironment) {
        ...
        for (TypeElement annotation : annotations) {
            ...
            for (Element element : elements) {
                ...
                //获取注解
                TestAnnoation annotation1 = element.getAnnotation(TestAnnoation.class);
                //获取注解中的值
